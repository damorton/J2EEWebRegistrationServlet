 ...
 */
@WebServlet("/SearchPres")
public class SearchPres extends HttpServlet {
	 ...
	 */
	public SearchPres() throws SQLException {
		super();
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String keywords = request.getParameter("SearchPres");

			if (keywords != null) {
				result = stmt
						.executeQuery("select * from presenters where name like '%"
								+ keywords + "%'");
			} else {
				result = stmt.executeQuery("select * from presenters;");
			}
			...
			int colCount = rsmd.getColumnCount(); // number of columns on the table
